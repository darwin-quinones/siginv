...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            <h1 class="h3 mb-2 text-info">Editar Gavetas</h1>
            <p class="mb-4">
                        ...
                        <form class="" action="<?php echo URL_SISINV;?>Gaveta/EditarGaveta/<?php echo $datos['idGaveta'];?>" method="POST">
                            <div class="row">
                                <div class="position-relative form-group col-md-12">
                                    ...
                                    <input onkeyup="mayus(this);" class="form-control" name="NUM_GAVETA" value="<?php echo $datos['numGaveta'];?>" type="number" required>
                                    <br>
