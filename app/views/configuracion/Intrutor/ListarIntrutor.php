...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            <h1 class="h3 mb-2 text-gray-800">Listado de Intrutor</h1>
            <p class="mb-4">
               Registre la cantidad de INTRUTORES que estas asociados .
            </p>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">REGISTRAR INTRUTOR</h5>
                        <form class="" action="<?php echo URL_SISINV;?>Bodega/RegistrarBodega" method="POST">
                            <div class="row">
                                ...
                                <label class="" style="font-weight: bold;">
                                    ...
                                    <input onkeyup="mayus(this);" class="form-control" name="NOM_REGIONAL" placeholder="NOMBRE DE INTRUTOR" type="text" required>
