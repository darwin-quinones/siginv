  ...
  <div id="wrapper">
    ...
    <!--VALIDACION DEL MENU DINAMICO CON PRIVILEGIOS-->
                    <?php 
                        ...
                        }elseif ($_SESSION['sesion_active']['tipo_usuario'] == 'ALMACENISTA') {
                            require 'menus/Almacenista.php';
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="<?php echo URL_SISINV;?>Persona/ListadoPersona">
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body"><h6>Seleciona "Cerrar Sesión" si quieres finalizar sesion.</h6></div>
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
          <a class="btn btn-primary" href="<?php echo URL_SISINV;?>Login/Logout">Cerrar Sesión</a>
        </div>
      </div>
    </div>
  </div>
